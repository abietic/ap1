...
public class RocketMqProducer {
    ...
    public void init() throws MQClientException {
        ...
        logger.info("Start MQ producer init.");
        transactionMQProducer = new TransactionMQProducer("trans_producer_group");
        transactionMQProducer.setNamesrvAddr(namesrvAddr);
        logger.info("Set name server {}.", namesrvAddr);
        logger.info("Regist transaction listener.");
        transactionMQProducer.setTransactionListener(new TransactionListener() {
            ...
            public LocalTransactionState executeLocalTransaction(Message msg, Object arg) {
                ...
                logger.info("prepare message sent and preperation succeeded.");
                ...
                try {
                    ...
                    logger.error("BusinessException occured when creating order.", e);
                    // 设置对应的stocklog为回滚状态
                    Map<String, Object> argsMap = (Map<String, Object>) arg;
                    String stockLogId = (String) argsMap.get("stockLogId");
                    StockLog stockLog = stockLogMapper.selectByPrimaryKey(stockLogId);
                    ...
                    logger.error("Unknown exception occured when creating order.", e);
                    return LocalTransactionState.ROLLBACK_MESSAGE;
                }
        ...
        logger.info("Transaction MQ producer start complete.");
    }
    ...
    public boolean transactionAsyncDecreaseStock(Integer itemId, Integer amount, Integer promoId, Integer userId,
        ...
        logger.info("Start sending prepare half message to topic {}.", topicName);
    ...
    // // 同步扣库存消息,不具有事务性
    // public SendResult asyncDecreaseStock(final Integer itemId, final Integer
    // amount)
